...
- weights    400 · 300 · 500 · 700
- base size  16px

## Spacing

- scale      1px · 48px · 52px · 56px · 60px · 64px · 72px · 80px · 96px · 191px · 244px · 340px

## Radii

- scale      1px · 4px · 8px · 16px · 28px · 36px
...
- CTA verbs  read · stripe · continue · sign · get · pay
