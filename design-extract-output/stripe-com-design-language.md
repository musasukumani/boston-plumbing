...
| Secondary | `#e5edf5` | rgb(229, 237, 245) | hsl(210, 44%, 93%) | 99 |
| Accent | `#ffe5da` | rgb(255, 229, 218) | hsl(18, 100%, 93%) | 5 |

### Neutral Colors

| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#000000` | hsl(0, 0%, 0%) | 3402 |
| `#50617a` | hsl(216, 21%, 40%) | 506 |
| `#ffffff` | hsl(0, 0%, 100%) | 346 |
| `#64748d` | hsl(217, 17%, 47%) | 274 |
| `#7d8ba4` | hsl(218, 18%, 57%) | 14 |
| `#101010` | hsl(0, 0%, 6%) | 10 |
| `#ebeef1` | hsl(210, 18%, 93%) | 5 |
| `#d8dee4` | hsl(210, 18%, 87%) | 4 |
| `#ffe6f5` | hsl(324, 100%, 95%) | 4 |
| `#707070` | hsl(0, 0%, 44%) | 2 |
| `#d4d4d4` | hsl(0, 0%, 83%) | 1 |

### Background Colors

Used on large-area elements: `#ffffff`, `#e5edf5`, `#f8fafd`, `#5d0252`, `#fffafd`, `#0d1738`, `#122054`, `#000000`, `#e6ebf1`
...
```css
background-image: linear-gradient(90deg, rgba(0, 0, 0, 0) 0px, rgb(40, 116, 173) 50%, rgba(0, 0, 0, 0) 100%);
```
...
```css
background-image: conic-gradient(rgb(255, 215, 239) 0%, rgb(255, 215, 239) 25%, rgb(165, 29, 133) 50%, rgb(255, 215, 239) 75%, rgb(255, 215, 239) 100%);
```
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#000000` | text, border, background | 3402 |
| `#061b31` | text, border, background | 919 |
| `#533afd` | text, border, background | 900 |
| `#50617a` | text, border | 506 |
| `#ffffff` | background, text, border | 346 |
| `#64748d` | text, border | 274 |
| `#e5edf5` | background, border | 99 |
| `#0000ee` | text, border | 90 |
| `#1a2c44` | text, border | 44 |
| `#2874ad` | text, border | 44 |
| `#ff6118` | text, border | 37 |
| `#7f7dfc` | text, border, background | 37 |
| `#3c4f69` | text, border | 36 |
| `#273951` | text, border | 32 |
| `#7389ff` | text, border | 30 |
| `#15be53` | background, border | 28 |
| `#b9b9f9` | border | 22 |
| `#a51d85` | text, border | 20 |
| `#ffd7ef` | border, background | 19 |
| `#5b6bff` | text, border | 16 |
| `#00b261` | text, border | 16 |
| `#4f2055` | text, border | 16 |
| `#7d8ba4` | text, border | 14 |
| `#108c3d` | text | 14 |
| `#d6d9fc` | border | 10 |
| `#101010` | text, border | 10 |
| `#6b59fe` | text, border | 9 |
...
- **sohne-var** — used for all (3353 elements)
- **SourceCodePro** — used for body (73 elements)
...
| 26px | 1.625rem | 400 | normal | normal | div, h3, p, span |
| 24px | 1.5rem | 400 | normal | -0.72px | div |
| 22px | 1.375rem | 300 | 24.2px | -0.22px | h3, p |
| 21px | 1.3125rem | 500 | 27.3px | 0.139px | div |
| 20px | 1.25rem | 300 | 28px | -0.2px | p |
| 18px | 1.125rem | 300 | 25.2px | normal | p, div, svg, rect |
| 16px | 1rem | 400 | normal | normal | html, head, meta, link |
| 15px | 0.9375rem | 400 | 21px | normal | div |
| 14px | 0.875rem | 400 | 14px | normal | button, svg, path, a |
| 13px | 0.8125rem | 400 | normal | -0.205px | div, span |
| 12px | 0.75rem | 400 | normal | normal | div, span, svg, rect |
| 11px | 0.6875rem | 300 | 16px | normal | div, span, svg, circle |
...
`400` (2701x), `300` (651x), `500` (74x), `700` (1x)
...
| spacing-191 | 191px | 11.9375rem |
| spacing-244 | 244px | 15.25rem |
...
**sm (inset)** — blur: 4.634px
```css
box-shadow: rgba(10, 37, 64, 0.22) 0px -1.854px 4.634px 0px inset;
```
...
**xl** — blur: 31.863px
```css
box-shadow: rgba(50, 50, 93, 0.12) 0px 15.931px 31.863px 0px;
```

**xl** — blur: 31.863px
```css
box-shadow: rgba(50, 50, 93, 0.12) 0px 15.931px 31.863px -8px;
```
...
**xl** — blur: 48.8px
```css
box-shadow: rgba(50, 50, 93, 0.12) 0px 4px 48.8px -30px, rgba(0, 0, 0, 0.1) 0px 18px 36px -18px;
```
...
```css
.badge {
  background-color: rgba(21, 190, 83, 0.2);
  color: rgb(6, 27, 49);
  font-size: 10px;
  font-weight: 300;
  padding-top: 0px;
...
```css
  background: rgb(236, 237, 254);
  color: rgb(107, 89, 254);
  padding: 4px 6px 4px 6px;
  border-radius: 4.51px;
  border: 0px none rgb(107, 89, 254);
  font-size: 11px;
  font-weight: 400;
```
...
**102 grid containers** and **533 flex containers** detected.
...
**Gap values:** `0px 10px`, `10px`, `12px`, `12px normal`, `13.824px`, `14px`, `16px`, `16px normal`, `20px normal`, `24px`, `24px normal`, `26px`, `28px`, `3.2px`, `32px`, `32px 16px`, `32px normal`, `3px`, `40px`, `40px 16px`, `40px normal`, `48px`, `4px`, `4px normal`, `56px 16px`, `5px`, `64px`, `6px`, `6px normal`, `7px normal`, `80px`, `8px`, `8px 16px`, `8px normal`, `96px`, `normal 10px`, `normal 12px`, `normal 16px`, `normal 24px`, `normal 4px`, `normal 6px`, `normal 7px`, `normal 8px`
...
|----------|-----------|-------------|-------------|-----------|-------------|
| mobile (375px) | 16px | Yes | 12 | Yes | 20391px |
| tablet (768px) | 16px | Yes | 12 | Yes | 15104px |
| desktop (1280px) | 16px | Yes | 12 | No | 14482px |
| wide (1920px) | 16px | Yes | 12 | No | 14862px |

### Breakpoint Changes

**375px → 768px** (mobile → tablet):
- H1 size: `34px` → `40px`
- Page height: `20391px` → `15104px`

**768px → 1280px** (tablet → desktop):
- H1 size: `40px` → `48px`
- Hamburger menu: `shown` → `hidden`
- Page height: `15104px` → `14482px`

**1280px → 1920px** (desktop → wide):
- Page height: `14482px` → `14862px`
...
```css
/* Hover */
color: rgb(10, 31, 53) → rgb(100, 116, 141);
border-color: rgb(10, 31, 53) → rgb(100, 116, 141);
outline: rgb(10, 31, 53) none 3px → rgb(100, 116, 141) none 3px;
```
```css
/* Focus */
color: rgb(10, 31, 53) → rgb(55, 73, 97);
border-color: rgb(10, 31, 53) → rgb(55, 73, 97);
outline: rgb(10, 31, 53) none 3px → rgb(83, 58, 253) solid 2px;
```

**"Developers"**
```css
/* Focus */
color: rgb(100, 116, 141) → rgb(55, 74, 97);
border-color: rgb(100, 116, 141) → rgb(55, 74, 97);
...
**Overall Score: 76%** — 16 passing, 5 failing color pairs
...
| `#ff6118` | `#ffe5da` | 2.5:1 | FAIL | span (1x) |
| `#6b59fe` | `#ecedfe` | 4.04:1 | FAIL | span (1x) |
...
| `#50617a` | `#ebeef1` | 5.41:1 | AA |
| `#533afd` | `#ffffff` | 6.19:1 | AA |
| `#ffffff` | `#23356e` | 11.63:1 | AAA |
| `#101d4e` | `#92adff` | 7.37:1 | AAA |
...
**Strengths:** Well-defined spacing scale, Consistent border radii, Good CSS variable tokenization

**Issues:**
- 5 WCAG contrast failures
- 52% of CSS is unused — consider purging
- 6135 duplicate CSS declarations
...
| base | -1,4 | div.n.a.v.i.g.a.t.i.o.n.-.m.e.n.u._._.b.a.c.k.g.r.o.u.n.d, div.s.e.c.t.i.o.n.-.c.o.n.t.a.i.n.e.r. .h.e.r.o.-.l.o.g.o.-.s.e.c.t.i.o.n, div.s.e.c.t.i.o.n.-.b.a.c.k.g.r.o.u.n.d. .m.o.d.u.l.a.r.-.s.o.l.u.t.i.o.n.s.-.b.g |
...
**135 unique SVG icons** detected. Dominant style: **filled**.
...
**Icon colors:** `#031323`, `var(--hds-color-text-solid)`, `currentColor`, `#fff`, `white`, `black`, `var(--hds-color-surface-bg-quiet)`, `rgb(0, 0, 0)`, `#4285f4`, `#34a853`
...
| gallery | 14 | objectFit: fill, borderRadius: 0px, shape: square |
| hero | 3 | objectFit: cover, borderRadius: 0px, shape: square |

**Aspect ratios:** 4.18:1 (36x), 1:1 (13x), 21:9 (11x), 3:4 (9x), 4:3 (6x), 9:16 (4x), 2:3 (2x), 16:9 (2x)
...
- **custom** (76 uses) — `cubic-bezier(0.45, 0.05, 0.55, 0.95)`, `cubic-bezier(0.4, 0, 0.2, 1)`, `cubic-bezier(0.6, 0, 0.2, 0.5)`
- **ease-out** (557 uses) — `cubic-bezier(0.25, 1, 0.5, 1)`, `cubic-bezier(0.165, 0.84, 0.44, 1)`, `cubic-bezier(0.16, 1, 0.3, 1)`
- **ease-in-out** (6 uses) — `ease`
- **linear** (46 uses) — `linear`
...
|---|---|---|
| default | 203 | Accept and optimize payments globally—on |
...
Reading order (top→bottom): cta → nav → pricing-table → testimonial → pricing-table → content → content → stats → pricing-table → testimonial → testimonial → pricing-table → nav → gallery → pricing-table → nav → pricing-table → pricing-table → pricing-table → gallery → cta → nav → nav → footer
...
| 7 | content | Not sure where to start? | 0.3 |
| 8 | content | — | 0.3 |
| 9 | stats | The backbone of global commerce | 0.85 |
| 10 | pricing-table | Powering businesses of all sizes. | 0.9 |
| 11 | testimonial | Transform your enterprise with agile financial infrastructure | 0.8 |
| 12 | testimonial | Transform your enterprise with agile financial infrastructure | 0.8 |
| 13 | pricing-table | Build a foundation for your startup that enables faster growth | 0.9 |
| 14 | nav | Build a foundation for your startup that enables faster growth | 0.4 |
| 15 | gallery | — | 0.7 |
| 16 | pricing-table | Make your SaaS platform a complete financial operating system | 0.9 |
| 17 | nav | Make your SaaS platform a complete financial operating system | 0.4 |
| 18 | pricing-table | Reliable, extensible infrastructure for every stack. | 0.9 |
...
**Label:** `flat-illustration` (confidence 0.227)
**Counts:** total 88, svg 43, icon 1, screenshot-like 0, photo-like 5
**Dominant aspect:** ultra-wide
**Radius profile on images:** square

## Component Screenshots

18 retina crops written to `screenshots/`. Index: `*-screenshots.json`.

| Cluster | Variant | Size (px) | File |
|---------|---------|-----------|------|
| button--default | 0 | 77 × 40 | `screenshots/button-default-0.png` |
| button--default | 1 | 78 × 40 | `screenshots/button-default-1.png` |
| button--default | 2 | 91 × 40 | `screenshots/button-default-2.png` |
| button--secondary | 0 | 84 × 40 | `screenshots/button-secondary-0.png` |
| button--secondary | 1 | 212 × 48 | `screenshots/button-secondary-1.png` |
| button--secondary | 2 | 166 × 40 | `screenshots/button-secondary-2.png` |
| button--primary | 0 | 137 × 40 | `screenshots/button-primary-0.png` |
| button--primary | 1 | 141 × 48 | `screenshots/button-primary-1.png` |
| button--primary | 2 | 230 × 48 | `screenshots/button-primary-2.png` |
| card--default | 0 | 38 × 38 | `screenshots/card-default-0.png` |
| card--default | 1 | 38 × 38 | `screenshots/card-default-1.png` |
| card--default | 2 | 688 × 58 | `screenshots/card-default-2.png` |
| card--default--md | 0 | 628 × 58 | `screenshots/card-default-md-0.png` |
| card--default--md | 1 | 274 × 29 | `screenshots/card-default-md-1.png` |
| card--default--md | 2 | 284 × 58 | `screenshots/card-default-md-2.png` |
| other--default | 0 | 100 × 60 | `screenshots/other-default-0.png` |
| other--default | 1 | 81 × 60 | `screenshots/other-default-1.png` |
| other--default | 2 | 141 × 60 | `screenshots/other-default-2.png` |
